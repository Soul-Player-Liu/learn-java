...
| 总索引 | [docs/INDEX.md](INDEX.md) | 维护文档分层、任务到文档映射和扩展位置。 | 承载某个专项的完整规范。 |
...
| 运行手册 | [docs/runbooks/*.md](runbooks/) | 记录本仓库当前可执行命令、操作步骤和排障路径。 | 可迁移标准和长期架构决策。 |
...
| 改动类型 | 必读文档 | 联动更新和证据 |
| --- | --- | --- |
| 仓库定位、启动方式、目录入口 | [README.md](../README.md)、[standards/documentation.md#readme-标准](standards/documentation.md#readme-标准) | [AGENTS.md](../AGENTS.md)、本文件的阅读顺序、[runbooks/validation.md](runbooks/validation.md)。 |
...
| Web mock、MSW、Storybook、离线预览 | [standards/frontend-mock.md#web-mock](standards/frontend-mock.md#web-mock)、[standards/frontend-mock.md#storybook](standards/frontend-mock.md#storybook) | Web handlers、stories、`build:mock`、`build:storybook`、相关 E2E。 |
| 移动端 mock、H5 构建、H5 E2E | [standards/frontend-mock.md#移动端-mock](standards/frontend-mock.md#移动端-mock)、[standards/testing.md#移动端测试](standards/testing.md#移动端测试) | `packages/mock-data`、移动端 mock API、`test:e2e:h5`、CI `mobile_check`。 |
| 文档新增、拆分、重命名、锚点链接 | [standards/documentation.md](standards/documentation.md)、[standards/documentation.md#链接和锚点](standards/documentation.md#链接和锚点) | 本文件、[AGENTS.md](../AGENTS.md)、所有受影响的反向链接、`scripts/check-doc-links.mjs`、CI `docs_check`。 |

## 文档原则

文档应遵循这些原则：

- 短入口：README 只保留定位、启动、验证入口和文档地图。
...
- [runbooks/validation.md](runbooks/validation.md)：按改动范围选择验证命令。
